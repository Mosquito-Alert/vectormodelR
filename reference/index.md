...
- [`get_malert_species_counts()`](https://labs.mosquitoalert.com/mosquitoR/reference/get_malert_species_counts.md)
...
- [`run_inla_bym2_model()`](https://labs.mosquitoalert.com/mosquitoR/reference/run_inla_bym2_model.md)
  : Fit a BYM2 model with INLA
- [`run_inla_model()`](https://labs.mosquitoalert.com/mosquitoR/reference/run_inla_model.md)
